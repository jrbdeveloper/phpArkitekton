 ...
 * Copyright (c) 2001-2009 Root Software and Open Concepts (Vic) Pty Ltd (ABN 12 130 429 248), Melbourne, Australia.
 * This script is free for all use as described in the "Copying and Use" and "Warranty and Disclaimer" sections below.
 *
 * Visit us at http://www.tectite.com/ for updates and more information.
 *
 *** If you use Tectite FormMail, please support its development and other freeware products by putting the following link on your website:
 ...
 * Read This First
 * ~~~~~~~~~~~~~~~
 *  This script is very well documented and quite large! It looks daunting, but really isn't.
 *  If you have experience with PHP or other scripting languages, here's what you *need* to read:
 *      - Configuration (TARGET_EMAIL & DEF_ALERT)
 *      - Creating Forms
 *  That's it!  (Alternatively, just read the Quick Start and/or Quicker Start section below).
 *  Full configuration documentation is here: http://www.tectite.com/fmdoc/index.php
 *
 *  NOTE: do not read or modify this script or any PHP script with DreamWeaver or FrontPage!
 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * On your web site, you may have one or more HTML forms that accept information from people visiting your website.  
 * Your aim is for your website to email that information to you and/or add it to a database. FormMail performs those functions.
 *
 * Quick Start
 * ~~~~~~~~~~~
 *  1. Edit this file and set TARGET_EMAIL for your requirements (near line 246 in this file - replace "yourhost\.com" with 
 * 		your mail server's name). We also strongly recommend you set DEF_ALERT (the next configuration below TARGET_EMAIL).
 * 
 *  2. Install this file as formmail.php (or other name ending in .php) on your web server.
 *     Test alerts by using your browser to open a URL to the script: http://www.yourhost.com/formmail.php?testalert=1
 *     Alerts are the only way FormMail can tell you the details of errors or faults.
 * 
 *  3. Create an HTML form and:
 *      - specify a hidden field called "recipients" with the email address of the person to receive the form's results.
 *      - in the your form tag set the action attribute to the formmail.php you uploaded to your web server
 *
 * Once you have FormMail working, you may be interested in some advanced usage and features.  
 * We have HOW-TO guides at www.tectite.com which describe many of the advanced processing you can do with FormMail. 
 * http://www.tectite.com/fmhowto/guides.php
 *
 * Quicker Start
 * ~~~~~~~~~~~~~
 *  Use the FormMail Configuration Wizard here: http://www.tectite.com/wizards/fmconf.php
 ...
 * Tectite FormMail has several security features designed into it.  
 * Note, however, it requires configuration for your particular web site.
 *
 * Configuration
 * ~~~~~~~~~~~~~
 *  To configure this script, go to the section titled "CONFIGURATION" (after reading the legal stuff below).
 *  There is only one mandatory setting: TARGET_EMAIL and one strongly recommended setting: DEF_ALERT
 *  Full configuration information is available here: http://www.tectite.com/fmdoc/index.php
 *
 * Creating Forms
 * ~~~~~~~~~~~~~~
 *  Go to this URL to learn how to write HTML forms for use with Tectite FormMail: http://www.tectite.com/fmdoc/creating_forms.php
 *
 * Copying and Use (Software License)
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *  Tectite FormMail is provided free of charge and may be freely distributed and used provided that you:
 *      1. keep this header, including copyright and comments, in place and unmodified; and,
 *      2. do not charge a fee for distributing it, without an agreement in writing with Root Software allowing you to do so; and,
 *      3. if you modify FormMail before distributing it, you clearly identify:
 *              a) who you are
 ...
 *  agreeing to our standard Terms and Conditions, available here: http://www.tectite.com/TermsAndConditions.pdf
 *
 *  This is free software and the Software License shown above is to be read in conjunction with our standard Terms and Conditions.
 *
 * Warranty and Disclaimer
 * ~~~~~~~~~~~~~~~~~~~~~~~
 *  Tectite FormMail is provided free-of-charge and with ABSOLUTELY NO WARRANTY.
 *  It has not been verified for use in critical applications, including, but not limited to, medicine, defense, aircraft, space exploration, or any other potentially dangerous activity.
 *  By using Tectite FormMail you agree to indemnify Root Software and Open Concepts (Vic) Pty Ltd, their agents, employees, directors and associated companies and businesses from any liability whatsoever.
 *
 * We still care
 * ~~~~~~~~~~~~~
 *  If you find a bug or fault in FormMail, please report it to us.
 *  We will respond to your report and make endeavours to rectify any faults you've detected as soon as possible.
 *
 *  To contact us please register on our forums at: http://www.tectite.com/vbforums/
 *  or view our contact information: http://www.tectite.com/contacts.php
 *
 * Version History
 * ~~~~~~~~~~~~~~~
 *  Near the top of this file, you'll find its version. The version
 *  line looks like this: $FM_VERS = "N.MM";     /* script version ...
 *
 *  The version history used to be located within this file. However, starting with Version 8.00 we've moved it...
 *
 *  You can read the complete version history of FormMail on our main website here: http://www.tectite.com/fmdoc/version_history.php
 */
...
$TARGET_EMAIL = array(EMAIL_NAME."@cox\.net$","^jabe@cox\.net$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","jabe@cox.net");
