...
/* 
 * UPDATE: 12/29/2010 - John Bales
 * Starting at line 739 I fixed a bug that required the user hold the SHIFT key to select a row
 * I just want the user to be able to click the row without holding the SHIFT to select the row
*/
