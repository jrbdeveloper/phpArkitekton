...
um.items = [
	...
	"right-red.gif",// menu indicator character/image ["text"|"image.gif"|"none"]
	"down-blue.gif",// menu indicator rollover character/image ["text"|"image.gif"|"none"] (must be same type)
...
um.menuItems = [
	...
	"",		// additional hover/focus CSS (careful!)
	"",		// additional visited CSS (careful!)
	"right-red.gif",// submenu indicator character/image ["text"|"image.gif"|"none"]
	"down-blue.gif",// submenu indicator rollover character/image ["text"|"image.gif"|"none"] (must be the same type)
